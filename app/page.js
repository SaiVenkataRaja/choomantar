    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 pb-24">
      ...
      <section className="relative h-[600px] w-full flex items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="max-w-3xl z-10">
          <span className="text-green-600 font-bold tracking-widest uppercase text-xs bg-emerald-500/10 backdrop-blur-md px-4 py-1.5 rounded-full inline-block mb-4 border border-emerald-500/20">
          ...
          <a href="#trips" className="bg-green-500 hover:bg-sky-600 text-slate-950 font-bold tracking-wider text-xs uppercase py-4 px-8 rounded-full transition-all duration-300 shadow-xl inline-block transform hover:-translate-y-0.5">
